...
export type Question =
  | { type: "yn"; id: string; text: string; lines?: string[]; noOption?: string; thirdOption?: string }
  | { type: "text"; id: string; text: string; max?: number }
  | { type: "field"; id: string; text: string }
  | { type: "group"; id: string; text: string; items: string[]; lines?: string[] }
  | { type: "table"; id: string; text: string; cols: string[]; rows: string[] }
  | { type: "note"; text: string }
  | { type: "reflections"; id: string };

export interface SubSection { id: string; title: string; questions: Question[]; }
...
const field = (id: string, text: string): Question => ({ type: "field", id, text });
const group = (id: string, text: string, items: string[], opts: Partial<Question> = {}): Question => ({ type: "group", id, text, items, ...opts } as Question);
const table = (id: string, text: string, cols: string[], rows: string[]): Question => ({ type: "table", id, text, cols, rows });
...
export const CONTEXT: Component = {
  ...
  subsections: [
    {
      id: "c.1", title: "Population & demographics",
      questions: [
    ...
    },
    {
      ...
      questions: [
        ...
        yn("ctx_referral", "Does a referral pathway exist for school health / school eye health?", { lines: ["If 'Yes', please describe"] }),
        ...
        yn("ctx_nhi", "Coverage of children for eye health in National Health Insurance"),
      ],
    },
  ],
};
...
export const COMPONENTS: Component[] = [
  {
    ...
    subsections: [
      { id: "1.1", title: "Legislation", questions: [
        yn("c1_leg", "Is school health included in national legislation frameworks?", { lines: ["What is the context and how does it relate to sector policies?", "What are the implementation frameworks, if any?", "What key factors limit or impede their implementation?"] }),
      ]},
      { id: "1.2", title: "Policies, Sector Strategies and Plans", questions: [
        ...
        yn("c1_ipec", "Is school health included in the Integrated People-Centred Eye Care (IPEC) Plan?", { noOption: "No IPEC Plan exists" }),
      ...
      { id: "1.3", title: "Finance", questions: [
      ...
      { id: "1.4", title: "Key Stakeholders and Coordination", questions: [
  ...
  },
  {
    ...
    subsections: [
      { id: "2.1", title: "Stakeholders", questions: [
      ...
      { id: "2.4", title: "Community level", questions: [
      ...
      { id: "2.5", title: "Secondary level", questions: [
      ...
      { id: "2.6", title: "Tertiary level", questions: [
      ...
      { id: "2.7", title: "Referral Pathways", questions: [
      ...
      { id: "2.8", title: "Data", questions: [
        yn("c2_emis", "Are there indicators related to the health of children within the EMIS?", { thirdOption: "This does not exist", lines: ["Indicators linked to school eye health?", "Information flow schools › education authorities?"] }),
        yn("c2_hmis", "Are there indicators related to eye health within the HMIS / DHIS?", { thirdOption: "This does not exist", lines: ["Indicators linked to school eye health?", "Information flow schools › health authorities?"] }),
  ...
  },
  {
    ...
    subsections: [
      ...
      { id: "3.3", title: "Capacity Needs", questions: [
  ...
  },
  {
    ...
    subsections: [
      { id: "4.1", title: "Eyeglasses", questions: [
        ...
        yn("c4_essential", "Are eyeglasses on the MoH Essential Supplies List or Essential List of Assistive Technologies?"),
      ...
      { id: "4.2", title: "Availability of optical services", questions: [
      ...
      { id: "4.3", title: "Availability of eyeglasses", questions: [
      ...
      { id: "4.6", title: "Consumables", questions: [
      ...
      { id: "4.7", title: "Equipment", questions: [
  ...
  },
  {
    ...
    subsections: [
      { id: "5.1", title: "Cultural perceptions", questions: [
