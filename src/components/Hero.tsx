      ...
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-10 px-6 pb-16 pt-32 md:grid-cols-[1.1fr_0.9fr] md:pt-24">
        <div>
          ...
          >
            <button
              onClick={onBegin}
              className="group inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-[0_12px_28px_-10px_hsl(189_66%_26%/0.55)] transition hover:-translate-y-0.5 hover:bg-primary-600 hover:shadow-[0_16px_32px_-8px_hsl(189_66%_26%/0.55)]"
            >
